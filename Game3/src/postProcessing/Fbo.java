...
public class Fbo {
	...
	public void resolveToFbo(int readBuffer, Fbo outputFbo) {
		...
		GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, outputFbo.width,
				outputFbo.height, GL11.GL_COLOR_BUFFER_BIT
	...
	public void resolveToScreen() {
		...
		GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, Display.getWidth(),
				Display.getHeight(), GL11.GL_COLOR_BUFFER_BIT, GL11.GL_NEAREST);
		this.unbindFrameBuffer();
	}
	...
	private void determineDrawBuffers(){
		...
		if(this.multiTarget)drawBuffers.put(GL30.GL_COLOR_ATTACHMENT1);
		drawBuffers.flip();
	...
	private void createTextureAttachment() {
		...
		GL30.glFramebufferTexture2D(GL30.GL_FRAMEBUFFER,
				GL30.GL_COLOR_ATTACHMENT0, GL11.GL_TEXTURE_2D, colourTexture, 0);
	}
	...
	private int createMultisampleColourAttachment(int attachment) {
		...
		GL30.glRenderbufferStorageMultisample(GL30.GL_RENDERBUFFER, 4,
				GL11.GL_RGB8, width, height);
		GL30.glFramebufferRenderbuffer(GL30.GL_FRAMEBUFFER,
				attachment, GL30.GL_RENDERBUFFER, colourBuffer);
		return colourBuffer;
	}
